#region License
//-----------------------------------------------------------------------
// <copyright file="ServiceLocatorBase.cs" company="Pi2 LLC">
...
namespace Sigma.Core.ServiceLocator
{
    ...
    public abstract class ServiceLocatorBase : IServiceLocator
    {
        ...
        {
            foreach (object item in DoGetAllInstances<TService>())
            {
        ...
        protected abstract IEnumerable<TService> DoGetAllInstances<TService>();
        ...
        {
            return string.Format("Activation error occured while trying to get instance of type {0}, key {1}", serviceType.Name, key);
        }
        ...
        {
            return string.Format("Activation error occured while trying to get all instances of type {0}", serviceType.Name);
        }
    }
}
