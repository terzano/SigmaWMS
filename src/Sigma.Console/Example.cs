...
namespace Sigma.Console
{
    ...
    public class Example : ConsoleCommand
    {
        ...
        public override int Run(string[] remainingArguments)
        {
            ...
            System.Console.WriteLine(@"Called Example command - Argument1 = ""{0}"" Argument2 = ""{1}"" BooleanOption: {2}", Argument1, Argument2, BooleanOption);

            OptionalArgumentList.ForEach((item) => System.Console.WriteLine(@"List Item {0} = ""{1}""", OptionalArgumentList.IndexOf(item), item));
